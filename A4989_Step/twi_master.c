...
/************************************************************************
 * @fn		void TWI_Master_Initialise(void)
 * @brief	Call this function to set up the TWI master to its initial standby state.
 *
 * @note	Remember to enable interrupts from the main application after initializing the TWI.
 */
...
/************************************************************************
 * @fn		unsigned char TWI_Transceiver_Busy( void )
...
/************************************************************************
 * @fn		unsigned char TWI_Get_State_Info( void )
...
/************************************************************************
 * @fn		void TWI_Start_Transceiver_With_Data( unsigned char *msg, unsigned char msgSize )
...
/************************************************************************
 * @fn		void TWI_Start_Transceiver( void )
...
/************************************************************************
 * @fn		unsigned char TWI_Get_Data_From_Transceiver( unsigned char *msg, unsigned char msgSize )
...
ISR(TWI_vect)
{
	...
	switch (TWSR)
	{
		...
		//case TW_NO_STATE:									// No relevant state information available; TWINT = “0”
