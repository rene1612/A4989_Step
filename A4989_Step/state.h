 ...
 */
 #define STATE_TIMER_RESOLUTION	(F_CPU/256/128/8)
 ...
 */
 ...
 #define STATE_ON_FC				0x40	//!<Zustand alles OK (gleichmäßiges "langsames" Blinken Tastverhältnis 50/50)
 #define STATE_ON_SBC				0x41	//!<Zustand alles OK (gleichmäßiges "langsames" Blinken Tastverhältnis 50/50)
 ...
 #define STATE_INFO_ENC_B			0x22	//!<Zustand "Information" Encoder B hat sich geändert und wird 2s angezeigt
 #define STATE_INFO_ENC_C			0x23	//!<Zustand "Information" Encoder C hat sich geändert und wird 2s angezeigt
