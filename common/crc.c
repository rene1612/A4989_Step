...
/*
 ///////////////////////////////////////////////////////////////////////////////////
 //              Deklaration der dateispezifischen Variablen
 ///////////////////////////////////////////////////////////////////////////////////
 ...
 unsigned int Calc_CRC16(unsigned int crc, unsigned char ch)
  {
  	crc = (crc>>8) ^ crc16tab[(BYTE)(crc^ch)];
  	return crc;
  }
...
//##############################################################################
//
unsigned int crcUpdate(unsigned int crc, unsigned char ch)
//##############################################################################
{
	unsigned int tmp;
	unsigned char j;
